...
### Original file path: bilby/bilby/core/prior/joint.py
###############################################
import re
...
class MultivariateGaussianDist(BaseJointPriorDist):
    ...
    def add_mode(self, mus=None, sigmas=None, corrcoef=None, cov=None, weight=1.0):
        ...
        self.mvn.append(
            scipy.stats.multivariate_normal(mean=np.zeros(self.num_vars), cov=self.corrcoefs[-1], allow_singular = True)
        )
